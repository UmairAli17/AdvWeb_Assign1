...
class Shop(models.Model):
    ...
    # connect the owner to a user int he User model using a one-to-one relationship. each user will only have a single shop
    ...
    def create_shop(sender, **kwargs):
        # get the User model created signal - when user is created, get that instance
